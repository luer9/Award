    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <div style="width: 100%; height: 90%; text-align: center;">
                            <br>
                            <img src="../static/plugins/bootstrap-sweetalert/thumbs-up.jpg" id="awardPic">
                        </div>
                    </div>
                </div>
                <%--						<div class="row">--%>
                ...
                <%--								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
                <%--								<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#passModal">不通过</button>--%>
...
<script>
    $(function () {
        ...
        if (index != -1) {
            //参数准备
            var checkId = GetQueryValue1("CHECKCODE");
            var stuId = GetQueryValue1("SID");
            var awardId = GetQueryValue1("AID");
            ...
            $.ajax({
                ...
                success: function (value) {
                    ...
                    if (value.data.checkFlag == -1)
                        $("#checkFlag").text('待审核！');
                    else if (value.data.checkFlag == 1)
                        $("#checkFlag").text('通过！');
                    else if (value.data.checkFlag == 0)
                        $("#checkFlag").text('未通过！');
                    $("#notes").text(value.data.notes+ "");
                    // $("#awardPic").text();
                },
                error: function () {
                    alert("error");
